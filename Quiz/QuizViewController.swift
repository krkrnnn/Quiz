...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["ナルトの誕生日はいつ？","1月1日","8月8日","10月10日",3])
        tmpArray.append(["ナルトは何代目火影？","6代目","7代目","8代目",2])
        tmpArray.append(["ナルトが好きなラーメンの味は？","醤油","味噌","塩",2])
        tmpArray.append(["サスケの嫌いな食べ物は？","納豆","ピーマン","刺身",1])
        tmpArray.append(["ナルトの息子の名前は？","メンマ","トンコツ","ボルト",3])
        tmpArray.append(["カカシ先生の写輪眼はどこにあるでしょう？","右目","左目","両目",2])
        //------------------------ここから上にクイズを書く------------------------//
